...
│
├── architectures/               # Diagram images of model architectures
│   ├── s2p.png                  # Seq-to-point architecture
│   ├── s2p hybrid 2 stage gating.png # Hybrid S2PwA architecture
│   └── auglpn.png               # AugLPN architecture
│
